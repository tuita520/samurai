...
namespace Phenix.Unity.Editor
{
    ...
    public static class UIDefaultControls
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static GameObject CreateFunctionalGraph( UIResources resources )
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static GameObject CreatePieGraph( UIResources resources )
        {
        ...
        /// </summary>
        public static GameObject CreateUITree( UIResources resources )
        {
            //create ui tree
        ...
        /// Create UITreeNode
        /// </summary>
        public static GameObject CreateUITreeNode( UIResources resources )
        {
            //create tree node
        ...
        /// Create Calendar
        /// </summary>
        public static GameObject CreateCalendar( UIResources resources )
        {
        ...
        /// Create Date Picker
        /// </summary>
        public static GameObject CreateDatePicker( UIResources resources )
        {
            DefaultControls.Resources res = convertToDefaultResources(resources);
            // Create date picker
        ...
        /// </summary>
        public static GameObject CreataVerticalColoredTape( UIResources resources )
        {
        ...
        /// </summary>
        public static GameObject CreataHorizontalColoredTape( UIResources resources )
        {
        ...
        /// <returns></returns>
        public static GameObject CreateColorPicker( UIResources resources )
        {
        ...
        /// <param name="resources"></param>
        /// <returns></returns>
        public static GameObject CreateLineChartGraph( UIResources resources )
        {
            // line chart 
        ...
        /// <param name="resources"></param>
        /// <returns></returns>
        public static GameObject CreateRadarMap( UIResources resources )
        {
        ...
        public static GameObject CreateBarChart( UIResources resources )  
        {
